...
public class EnvConstants {
    ...
    public static final String UDATE_FAILED_RECORDS = "update_cassandra_failed__record.txt";
    public static final String UDATE_SUCCESS_RECORDS = "update_cassandra_success__record.txt";
    public static final String UDATE_ES_FAILED_RECORDS = "update_es_failed__record.txt";
    public static final String UDATE_ES_SUCCESS_RECORDS = "update_es_success__record.txt";
